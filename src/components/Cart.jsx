  ...
  return (
    <div className=" bg-[#0000007d] w-full min-h-screen fixed left-0 top-0 z-20 overflow-y-scroll">
      <div className=" max-w-[400px] w-full min-h-full bg-white absolute right-0 top-0 p-6">
        ...
        <button className="bg-ExtraDarkColor text-white w-full py-2 font-medium mb-2"  onClick={() => { handleProceedToBuy(); setShowCart(false); }}>
  Proceed to Buy
</button>
<button className="bg-ExtraDarkColor text-white w-full py-2 font-medium" onClick={() => setShowCart(false)}>
  Go back
</button>
